<?php
    ...
    try {
        ...
        $objeto_TablasBBDD_model->insertar_nuevo_asegurado($insertar_nombre, $insertar_direccion, $insertar_telefono, $insertar_dom_rep);
        ...
        $mensaje_consulta = "<br>Error al intentar insertar el nuevo asegurado<br> Error: " . $e->getMessage();
        $_SESSION['mensaje_consulta'] = $mensaje_consulta;
